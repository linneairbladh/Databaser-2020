...
public class UniversityApplication {
	...
	private void initialize() {
		...
		frame.getContentPane().add(tabbedPane);;
			...
			courseScrollPane.setBounds(41, 107, 345, 114);
			...
			btnShowAllCourses.setBounds(125, 73, 163, 23);
			...
			JLabel lblWelcomeToOur = new JLabel("Welcome to our university!");
			lblWelcomeToOur.setFont(new Font("Palatino Linotype", Font.PLAIN, 14));
			lblWelcomeToOur.setBounds(125, 37, 173, 23);
			panel_Overview.add(lblWelcomeToOur);
